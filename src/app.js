...
app.get('/', function(req, res) {
 ...
 res.status(200).send('<head><link rel="stylesheet" type="text/css" href="css/styles.css"</head><body><h1>DOGGOS</h1><h3><a href="/gallery">SHOW ME THE POOCHIES</a></h3></body>');
});
...
app.get('/gallery', function(req, res) {
  ...
  // all possible images
  let allImgs = ['animal1', 'animal2', 'animal3', 'animal4'];
  ...
  // send body
  res.status(200).send('<head><link rel="stylesheet" type="text/css" href="css/styles.css"</head><body><h1>Look At All These Cuties</h1><div>' + imgs + '</div></body>');
});
